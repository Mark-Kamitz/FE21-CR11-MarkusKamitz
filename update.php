...
if (isset($_POST["submit"])) {
    ...
    if ($pictureArray->error === 0) {       
        ...
        $sql = "UPDATE users SET first_name = '$f_name', last_name = '$l_name', email = '$email', phone = '$phone', address = '$address', picture = '$pictureArray->fileName' WHERE id = {$id}";
    } else {
        $sql = "UPDATE users SET first_name = '$f_name', last_name = '$l_name', email = '$email', phone = '$phone', address = '$address' WHERE id = {$id}";
    }
        ...
        <form  method="post" enctype="multipart/form-data">
            <table class="table">
                ...
                <tr>
                    ...
                    <td><button name="submit" class="btn btn-outline-success btn-sm" type= "submit">Save</button></td>
                    <td><a href= "<?php echo $backBtn?>"><button class="btn btn-outline-warning btn-sm" type="button">Back</button></a></td>
                </tr>
            </table>
        </form>  
    <fieldset>  
