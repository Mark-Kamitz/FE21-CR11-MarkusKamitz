...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_array(MYSQLI_ASSOC)) {
        $tbody .= "<tr>
            ...
            <td>" . $row['email'] . "</td>
            <td>
                <a href='update.php?id=" . $row['id'] . "'><button class='btn btn-outline-warning btn-sm' type='button'><i class='far fa-edit'></i></button></a>
                <a href='delete.php?id=" . $row['id'] . "'><button class='btn btn-outline-danger btn-sm' type='button'><i class='far fa-trash-alt'></i></button></a>
            </td>
         </tr>";
    }
} else {
